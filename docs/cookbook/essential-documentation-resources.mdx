...
# Base & Coinbase Developer Resources
...
<step>
  Navigate to docs.base.org and locate the MiniKit quickstart guide to
  understand the project structure.
</step>
<step>
  Create a Coinbase Developer Platform account and explore the Paymaster API
  documentation.
</step>
